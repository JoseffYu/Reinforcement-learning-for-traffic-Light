...
class DQN:
    ...
    def selectAction(self, state):
        ...
        if sample > eps_threshold:
            ...
            return torch.tensor([self.env.action_space.sample()], device=device, dtype=torch.long).unsqueeze(0)
    ...
    def learn(self):
        ...
        expected_state_action_values = reward_batch + self.gamma * target_action_values *(1-dones_batch) # Compute the expected Q values
