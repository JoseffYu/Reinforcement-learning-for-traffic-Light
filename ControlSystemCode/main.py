...
def main():
    ...
    agent = DQN(env = env,mode="train",input_dim=input_dim,output_dim=output_dim,gamma=0,replay_size=20000,batch_size=32,eps_start=0.95,eps_end=0.05,eps_decay=30000,LR=1e-4,TAU=0.1)
    ...
    plt.title('Returns for ATL(Greedy)')
    plt.xlabel('Episodes')
    plt.ylabel('returns')
    ...
    plt.savefig('/Users/yuyanlin/Desktop/AdaptiveTrafficLight/GreedyRule.png')
