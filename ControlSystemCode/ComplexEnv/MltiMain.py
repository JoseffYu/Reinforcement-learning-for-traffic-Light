import subprocess
from MultiSUMOEnv import SumoEnv
...
def main():
    ...
    plt.title('Returns for ATL(PER-Fix-epsilon)')
    plt.xlabel('Episodes')
    plt.ylabel('returns')
    ...
    plt.savefig('/Users/yuyanlin/Desktop/AdaptiveTrafficLight/Multi-PER-Fix-epsilon.png')
