...
class TrafficLight:
    def __init__(
        ...
        for tl_id in self.tls_id:
            ...
            self.lanes_length_list.append(self.lanes_length)
    ...
    def computeReward(self, tl_id, action):

        update_reward = True
        
        return self.chooseMinWaitTime(action, tl_id, update_reward)
    
    
    def chooseMinWaitTime(self,tl_id, action, update_reward):
        self.dict_lane_veh = {}
        ...
        if tl_id == 'J22':
            dict_action_wait_num = [self.dict_lane_veh['E1_1'] + self.dict_lane_veh['-E2_1'],
                                    self.dict_lane_veh['-N2_2'] + self.dict_lane_veh['-S2_2'],
                                    self.dict_lane_veh['-N2_1'] + self.dict_lane_veh['-S2_1'],
                                    self.dict_lane_veh['E1_2'] + self.dict_lane_veh['-E2_2']
                                    ]
        else:
