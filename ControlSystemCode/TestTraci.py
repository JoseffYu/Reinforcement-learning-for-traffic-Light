...
while step < 1000:
    ...
    print('num vehicles',traci.lane.getLastStepHaltingNumber(traffic_lanes_id[0]))
    print(traci.lane.getLastStepMeanSpeed(traffic_lanes_id[0]))
    print(traci.lane.getLastStepMeanSpeed())
